...
public class LoginPanel extends JFrame
{
    ...
    public static String Passwd;//记录密码
    ...
    private void button2ActionPerformed(ActionEvent e)
    {
        ...
        if (comboBox1.getSelectedIndex() == 0)
        {
            ...
            db.pre();
            MD5 md5 = new MD5();
            Passwd = md5.MD5WithoutSalt(passwordField1.getText());
            try
            {
    ...
    private void initComponents()
    {
        ...
        ((GridBagLayout) contentPane.getLayout()).rowHeights = new int[]{19, 37, 22, 0, 0, 0, 0, 46, 0};
        ...
        contentPane.add(button2, new GridBagConstraints(2, 6, 2, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));
        pack();
